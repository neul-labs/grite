...
This document describes all grit configuration files and options.

## Configuration Files

Grit uses two configuration files:

| File | Scope | Purpose |
|------|-------|---------|
| `.git/grit/config.toml` | Repository | Repository-wide settings |
| `.git/grit/actors/<id>/config.toml` | Actor | Per-actor settings |

## Repository Configuration

Location: `.git/grit/config.toml`
...
Location: `.git/grit/actors/<actor_id>/config.toml`
...
- **Type**: string (32-character hex)
- **Required**: yes
- **Generated by**: `grit init` or `grit actor init`
...
- **Type**: string
- **Required**: no
- **Set by**: `grit actor init --label <name>`
...
- **Required**: no
- **Generated by**: `grit actor init --generate-key`
