...
pub fn export_json(store: &GritStore, since: Option<ExportSince>) -> Result<JsonExport, GritError> {
...
pub fn export_markdown(store: &GritStore, _since: Option<ExportSince>) -> Result<String, GritError> {
