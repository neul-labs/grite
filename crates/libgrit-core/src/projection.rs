...
impl IssueProjection {
    ...
    pub fn apply(&mut self, event: &Event) -> Result<(), GritError> {
    ...
    pub fn from_event(event: &Event) -> Result<Self, GritError> {
        match &event.kind {
