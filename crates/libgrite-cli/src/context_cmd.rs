...
pub fn context_query(
    ctx: &GriteContext,
    opts: &ContextQueryOptions,
) -> Result<ContextQueryResult, GriteError> {
    let _ = ctx;
    let _ = opts;
...
) -> Result<ContextShowResult, GriteError> {
    let _ = ctx;
    let _ = opts;
...
pub fn context_project(
    ctx: &GriteContext,
    opts: &ContextProjectOptions,
) -> Result<ContextProjectResult, GriteError> {
    let _ = ctx;
    let _ = opts;
...
) -> Result<ContextSetResult, GriteError> {
    let _ = ctx;
    let _ = opts;
