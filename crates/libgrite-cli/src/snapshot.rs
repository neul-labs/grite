...
pub fn snapshot_create(
    ctx: &GriteContext,
    _opts: &SnapshotCreateOptions,
) -> Result<SnapshotCreateResult, GriteError> {
    let _ = ctx;
...
pub fn snapshot_list(
    ctx: &GriteContext,
    _opts: &SnapshotListOptions,
) -> Result<SnapshotListResult, GriteError> {
    let _ = ctx;
...
pub fn snapshot_gc(
    ctx: &GriteContext,
    _opts: &SnapshotGcOptions,
) -> Result<SnapshotGcResult, GriteError> {
    let _ = ctx;
