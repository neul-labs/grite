...
//!     let issues = issue_list_async(ctx, IssueListOptions::default()).await.unwrap();
//! }
//! ```
...
macro_rules! async_wrapper {
    ($name:ident, $sync_fn:path, ($ctx:ident, $opts:ident)) => {
        ...
        {
            let ctx = $ctx.clone();
            tokio::task::spawn_blocking(move || $sync_fn(&ctx, $opts)).await.unwrap()
        }
    };
}
...
pub async fn issue_create_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_create(&ctx, &opts)).await.unwrap()
}
...
pub async fn issue_list_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_list(&ctx, &opts)).await.unwrap()
}
...
pub async fn issue_show_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_show(&ctx, &opts)).await.unwrap()
}
...
pub async fn issue_update_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_update(&ctx, &opts)).await.unwrap()
}
...
pub async fn issue_comment_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_comment(&ctx, &opts)).await.unwrap()
}
...
pub async fn issue_close_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_close(&ctx, &opts)).await.unwrap()
}
...
pub async fn issue_reopen_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::issue::issue_reopen(&ctx, &opts)).await.unwrap()
}
...
pub async fn sync_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::sync::sync(&ctx, &opts)).await.unwrap()
}
...
pub async fn export_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::export::export(&ctx, &opts)).await.unwrap()
}
...
pub async fn rebuild_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::rebuild::rebuild(&ctx, &opts)).await.unwrap()
}
...
pub async fn context_index_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::context_cmd::context_index(&ctx, &opts)).await.unwrap()
}
...
pub async fn db_check_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::db::db_check(&ctx, &opts)).await.unwrap()
}
...
pub async fn doctor_async(
    ...
    let ctx = ctx.clone();
    tokio::task::spawn_blocking(move || crate::doctor::doctor(&ctx, &opts)).await.unwrap()
}
